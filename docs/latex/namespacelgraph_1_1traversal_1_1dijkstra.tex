...
\subsubsection[{\texorpdfstring{Dijkstra(const wxgraph$<$ T $>$ $\ast$\+G, node source, djka\+\_\+terminate$<$ T $>$ term=[](const wxgraph$<$ T $>$ $\ast$, const djka\+\_\+node$<$ T $>$ \&, const vector$<$ bool $>$ \&) -\/$>$ bool\lcurly{}return false;\rcurly{}, djka\+\_\+process\+\_\+current$<$ T $>$ proc\+\_\+curr=[](const wxgraph$<$ T $>$ $\ast$, const djka\+\_\+node$<$ T $>$ \&, const vector$<$ bool $>$ \&) -\/$>$ void\lcurly{}\rcurly{}, djka\+\_\+process\+\_\+neighbour$<$ T $>$ proc\+\_\+neigh=[](const wxgraph$<$ T $>$ $\ast$, node, node, const T \&, const vector$<$ bool $>$ \&) -\/$>$ bool\lcurly{}return true;\rcurly{})}{Dijkstra(const wxgraph< T > *G, node source, djka_terminate< T > term=[](const wxgraph< T > *, const djka_node< T > &, const vector< bool > &) -> bool\{return false;\}, djka_process_current< T > proc_curr=[](const wxgraph< T > *, const djka_node< T > &, const vector< bool > &) -> void\{\}, djka_process_neighbour< T > proc_neigh=[](const wxgraph< T > *, node, node, const T &, const vector< bool > &) -> bool\{return true;\})}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T $>$ void lgraph\+::traversal\+::dijkstra\+::\+Dijkstra (
...
\item[{{\bf djka\+\_\+process\+\_\+neighbour}$<$ T $>$}]{proc\+\_\+neigh = {\ttfamily \mbox{[}\mbox{]}(const~{\bf wxgraph}$<$~T~$>$~$\ast$,~{\bf node},~{\bf node},~const~T~\&,~const~vector$<$~bool~$>$~\&)~-\/$>$~bool\{return~true;\}}}
\end{DoxyParamCaption}
)}\hypertarget{namespacelgraph_1_1traversal_1_1dijkstra_a841778a8e888fb90b5a39d54e5d776eb}{}\label{namespacelgraph_1_1traversal_1_1dijkstra_a841778a8e888fb90b5a39d54e5d776eb}
