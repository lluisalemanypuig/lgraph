...
\subsubsection[{\texorpdfstring{as\+\_\+vector(vector$<$ T $>$ \&v) const }{as_vector(vector< T > &v) const }}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T, class Alloc = allocator$<$\+T$>$$>$ void {\bf lgraph\+::utils\+::svector}$<$ T, Alloc $>$\+::as\+\_\+vector (
\begin{DoxyParamCaption}
\item[{vector$<$ T $>$ \&}]{v}
\end{DoxyParamCaption}
) const}\hypertarget{classlgraph_1_1utils_1_1svector_a8a801e9a3208655c4bbb21a7db75c58f}{}\label{classlgraph_1_1utils_1_1svector_a8a801e9a3208655c4bbb21a7db75c58f}
