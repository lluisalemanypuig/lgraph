...
\item[{{\bf bfs\+\_\+process\+\_\+neighbour}}]{proc\+\_\+neig = {\ttfamily \mbox{[}\mbox{]}(const~{\bf uxgraph}~$\ast$,~{\bf node},~{\bf node},~const~vector$<$~bool~$>$~\&)~-\/$>$~void\{\}}}
\end{DoxyParamCaption}
)}\hypertarget{namespacelgraph_1_1traversal_1_1bfs_a0acd8f941a6a141af8a080745596144e}{}\label{namespacelgraph_1_1traversal_1_1bfs_a0acd8f941a6a141af8a080745596144e}
