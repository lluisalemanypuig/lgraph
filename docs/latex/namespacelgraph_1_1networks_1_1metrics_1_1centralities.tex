...
Returns the betweenness centrality of a node, considering that a path between {\itshape u} and {\itshape v} contains both  and {\itshape v}. 
\end{DoxyReturn}
\index{lgraph\+::networks\+::metrics\+::centralities@{lgraph\+::networks\+::metrics\+::centralities}!betweenness@{betweenness}}
\index{betweenness@{betweenness}!lgraph\+::networks\+::metrics\+::centralities@{lgraph\+::networks\+::metrics\+::centralities}}
...
{\em G} & The graph to be evaluated \\
\hline
{\em paths} & {\itshape paths}\mbox{[}u\mbox{]}\mbox{[}v\mbox{]} contains all shortest paths between {\itshape u} and {\itshape v} for 0 $<$= u,v $<$ {\itshape G.\+n\+\_\+nodes()} \\
\hline
{\em u} & The node to be evaluated \\
\hline
\end{DoxyParams}
...
\hline
\mbox{\tt out}  & {\em bc} & bc\mbox{[}i\mbox{]} contains the betweenness centrality of the {\itshape i-\/th} node \\
\hline
\end{DoxyParams}
\index{lgraph\+::networks\+::metrics\+::centralities@{lgraph\+::networks\+::metrics\+::centralities}!betweenness@{betweenness}}
\index{betweenness@{betweenness}!lgraph\+::networks\+::metrics\+::centralities@{lgraph\+::networks\+::metrics\+::centralities}}
...
\mbox{\tt in}  & {\em G} & The graph to be evaluated \\
\hline
\mbox{\tt in}  & {\em paths} & {\itshape paths}\mbox{[}u\mbox{]}\mbox{[}v\mbox{]} contains all shortest paths between {\itshape u} and {\itshape v} for 0 $<$= u,v $<$ {\itshape G.\+n\+\_\+nodes()} \\
\hline
\mbox{\tt out}  & {\em bc} & bc\mbox{[}i\mbox{]} contains the betweenness centrality of the {\itshape i-\/th} node \\
\hline
\end{DoxyParams}
...
\mbox{\tt in}  & {\em G} & The graph to be evaluated \\
\hline
\mbox{\tt out}  & {\em The} & i-\/th position contains the normalised degree centrality of the i-\/th node. \\
\hline
\end{DoxyParams}
